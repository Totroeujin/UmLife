...
public class OngoingEventJoinedAdapter extends RecyclerView.Adapter<OngoingEventJoinedAdapter.MyView>{
    ...
    @NonNull
    @Override
    public OngoingEventJoinedAdapter.MyView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.event_list_item, parent, false);
        return new OngoingEventJoinedAdapter.MyView(itemView);
    }
    ...
    public OngoingEventJoinedAdapter(List<EventInfo> joinedEventList, FragmentActivity fragmentActivity){
