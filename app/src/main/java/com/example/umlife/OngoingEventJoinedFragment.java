 ...
 */
public class OngoingEventJoinedFragment extends Fragment {
    ...
    public OngoingEventJoinedFragment() {
    ...
    OngoingEventJoinedAdapter eventJoinedAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ongoing_event_joined, container, false);
                        ...
                        public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                            if(!queryDocumentSnapshots.isEmpty()){
                                for(int i=0; i<eventJoinedID.size(); i++) {
                                    ...
                                    eventJoinedAdapter = new OngoingEventJoinedAdapter(eventJoinedList, getActivity());
        ...
        BtnHistory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                HistoryEventJoinedFragment history = new HistoryEventJoinedFragment();
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.container, history).addToBackStack(null).commit();
            }
        });
         **/
